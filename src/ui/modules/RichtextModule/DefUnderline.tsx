...
const DefUnderline = ({ children }: PortableTextMarkComponentProps<any>) => {
	...
	return (
		<span ref={ref} className="relative inline-block">
			...
			>
				<mask id="draw-mask5" className={cn(isInView && 'anim-mask5')}>
					<rect
						x="0"
						y="0"
						width="0"
